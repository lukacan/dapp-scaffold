...
export const JanecekMethod: FC = () => {
    ...
    const createParty = async () =>{
        try {
            ...
            if(info != null)
            {
                setCreatedParty("Party already exists");
            }
            else
            {
            ...
            setCreatedParty("Error while creating party");
        ...
        <div className="flex flex-row justify-center">
            ...
            <div className="relative group items-center">
                ...
                {ourWallet.publicKey && !partyName && (
                    <div className="block w-60 m-2 text-black">Please enter a party name</div>
                )}
